...
$sql = "SELECT * FROM rafi_barang WHERE rafi_id_barang='$kode_barang'";
...
if (!$user) {
  echo "<script>alert('Data tidak ditemukan pada database.');window.location='lihat_barang.php';</script>";
  exit;
}
...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE rafi_barang 
        SET rafi_nama_barang = '$nama_barang', 
            rafi_jumlah_barang = '$jumlah_barang', 
            rafi_harga_barang = '$harga_barang', 
            rafi_dateupdate_barang = '$today' 
        WHERE rafi_id_barang = '$kode_barang'";


  if (mysqli_query($koneksi, $sql)) {
    echo "<script>alert('Data berhasil diperbarui.');window.location='lihat_barang.php';</script>";
  } else {
              ...
              <div class="card-body">
                ...
                <form action="" method="POST" class="forms-sample">
                  <div class="form-group">
                    ...
                    <input type="text" name="kode_barang" class="form-control" required="required" value="<?php echo htmlspecialchars($user['rafi_id_barang']); ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName2">Nama Barang</label>
                    <input type="text" name="nama_barang" class="form-control" id="exampleInputName2" value="<?php echo htmlspecialchars($user['rafi_nama_barang']); ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName3">Jumlah Barang</label>
                    <input type="number" name="jumlah_barang" class="form-control" id="exampleInputName3" value="<?php echo htmlspecialchars($user['rafi_jumlah_barang']); ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName4">Harga Barang</label>
                    <input type="number" name="harga_barang" class="form-control" id="exampleInputName4" value="<?php echo htmlspecialchars($user['rafi_harga_barang']); ?>">
                  </div>
