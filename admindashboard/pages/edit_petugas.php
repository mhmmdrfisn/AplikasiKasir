...
$sql = "SELECT * FROM rafi_users WHERE rafi_id_users='$id_users'";
...
if (!$user) {
  echo "<script>alert('Data tidak ditemukan pada database.');window.location='lihat_petugas.php';</script>";
  exit;
}
...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE rafi_users SET rafi_username = '$username', rafi_password = md5('$password'), rafi_nama_lengkap = '$fullname', rafi_alamat = '$alamat', rafi_role = '$role' WHERE rafi_id_users = '$id_users'";

  if (mysqli_query($koneksi, $sql)) {
    echo "<script>alert('Data berhasil diperbarui.');window.location='lihat_petugas.php';</script>";
  } else {
              ...
              <div class="card-body">
                ...
                <form action="" method="POST" class="forms-sample">
                  <div class="form-group">
                    ...
                    <input type="text" name="kode_barang" class="form-control" required="required" value="<?php echo htmlspecialchars($user['rafi_id_users']); ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName2">Username</label>
                    <input type="text" name="username" class="form-control" id="exampleInputName2" value="<?php echo htmlspecialchars($user['rafi_username']); ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName3">Nama Lengkap</label>
                    <input type="text" name="fullname" class="form-control" id="exampleInputName3" value="<?php echo htmlspecialchars($user['rafi_nama_lengkap']); ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName4">Password</label>
                    <input type="password" name="password" class="form-control" id="exampleInputName4" value="">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName5">Alamat</label>
                    <input type="text" name="alamat" class="form-control" id="exampleInputName5" value="<?php echo htmlspecialchars($user['rafi_alamat']); ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleSelectRole">Role</label>
                    <select class="form-control" id="exampleSelectRole" name="role">
                      <option value="Administrator" <?php if ($user['rafi_role'] == 'Administrator') echo 'selected'; ?>>Administrator</option>
                      <option value="Petugas" <?php if ($user['rafi_role'] == 'Petugas') echo 'selected'; ?>>Petugas</option>
                    </select>
                  </div>
