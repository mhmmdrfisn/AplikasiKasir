                      ...
                      <tbody>
                        <?php if (mysqli_num_rows($result) > 0) { ?>
                          ...
                          ?>
                            <tr>
                              <td><?php echo $no ?></td>
                              <td><?php echo $data["rafi_username"]; ?></td>
                              <td><?php echo $data["rafi_nama_lengkap"]; ?></td>
                              <td><?php echo $data["rafi_alamat"]; ?></td>
                              <td><?php echo $data["rafi_role"]; ?></td>
                              <td>
                                <a href='edit_petugas.php?rafi_id_users=<?php echo $data["rafi_id_users"]; ?>' class='btn btn-primary'><i class="ti-pencil-alt"></i></a>
                                <a href='delete_petugas.php?rafi_id_users=<?php echo $data["rafi_id_users"]; ?>' class='btn btn-danger' onclick='return confirm("Apakah Anda Yakin?")'><i class='ti-trash'></i></a>
                              </td>
                            </tr>
                          <?php $no++;
                          } ?>
