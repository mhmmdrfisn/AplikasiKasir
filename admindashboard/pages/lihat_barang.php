                      ...
                      <tbody>
                        <?php if (mysqli_num_rows($result) > 0) { ?>
                          ...
                          ?>
                            <tr>
                              <td><?php echo $no ?></td>
                              <td><?php echo $data["rafi_id_barang"]; ?></td>
                              <td><?php echo $data["rafi_nama_barang"]; ?></td>
                              <td><?php echo $data["rafi_jumlah_barang"]; ?></td>
                              <td><?php echo $data["rafi_harga_barang"]; ?></td>
                              <td><?php echo $data["rafi_dateadd_barang"]; ?></td>
                              <td><?php echo $data["rafi_dateupdate_barang"]; ?></td>
                              <td>
                                <a href='edit_barang.php?rafi_kode_barang=<?php echo $data["rafi_id_barang"]; ?>' class='btn btn-primary'><i class="ti-pencil-alt"></i></a>
                                <a href='delete_barang.php?rafi_kode_barang=<?php echo $data["rafi_id_barang"]; ?>' class='btn btn-danger' onclick='return confirm("Apakah Anda Yakin?")'><i class='ti-trash'></i></a>
                              </td>
                            </tr>
                          <?php $no++;
                          } ?>
