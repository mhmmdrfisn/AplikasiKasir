...
$query = mysqli_query($koneksi, "SELECT max(rafi_id_barang) as kodeTerbesar FROM rafi_barang");
          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form action="proses_tambah_barang.php" method="post" class="forms-sample">
                  <div class="form-group">
                    <label for="exampleInputName1">Kode Barang</label>
                    <input type="text" name="kode_barang" class="form-control" required="required" value="<?php echo $kodeBarang ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName2">Nama Barang</label>
                    <input type="text" name="nama_barang" class="form-control" id="exampleInputName2" placeholder="Nama Barang">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName3">Jumlah Barang</label>
                    <input type="number" name="jumlah_barang" class="form-control" id="exampleInputName3" placeholder="Jumlah Barang">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName4">Harga Barang</label>
                    <input type="number" name="harga_barang" class="form-control" id="exampleInputName4" placeholder="Harga Barang">
                  </div>
