        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form action="proses_register.php" method="post" class="pt-3">
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  <div class="text-center mt-4 font-weight-light"> Have an account? <a href="index.php" class="text-primary">Sign in</a>
                  </div>
              </form>
            </div>
          </div>
